...
enum token_e { Tk_Null = 0, Tk_EOF, Tk_LParen, Tk_RParen, Tk_Ident, Tk_Literal, Tk_Semi,
...
char * tk_print[] = { "Tk_Null", "Tk_EOF", "Tk_LParen", "Tk_RParen", "Tk_Ident", "Tk_Literal", "Tk_Semi",
                      "Tk_Op_Plus", "Tk_Op_Minus", "Tk_Op_Mul", "Tk_Op_Div",
                      "Tk_Kw_assign", "Tk_Kw_begin", "Tk_Kw_end", "Tk_Kw_endmodule", "Tk_Kw_inout", "Tk_Kw_input", "Tk_Kw_module", "Tk_Kw_output", "Tk_Kw_reg", "Tk_Kw_wire" };
...
int tokenize(char * char_stream, long size, struct token_s tok_array[]) {
   ...
   while (pos < size - 1) {
      if(isalpha(char_stream[pos])) {
         int len = take_while(isalpha, &char_stream[pos]);
